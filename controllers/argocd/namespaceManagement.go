...
func (r *ReconcileArgoCD) reconcileNamespaceManagement(argocd *argoproj.ArgoCD) error {
	...
	for _, update := range statusUpdates {
		if err := updateStatusConditionOfNamespaceManagement(ctx, createCondition(update.message, r.IsExternalAuthenticationEnabledOnOpenShiftCluster()), &update.nm, r.Client, log); err != nil {
