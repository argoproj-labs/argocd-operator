...
func (r *ReconcileClusterArgoCD) reconcileNotificationsController(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsConfigurationCR(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) deleteNotificationsResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsServiceAccount(cr *argoproj.ClusterArgoCD) (*corev1.ServiceAccount, error) {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsRole(cr *argoproj.ClusterArgoCD) (*rbacv1.Role, error) {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsRoleBinding(cr *argoproj.ClusterArgoCD, role *rbacv1.Role, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsClusterRoleBinding(cr *argoproj.ClusterArgoCD, clusterRole *rbacv1.ClusterRole, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsDeployment(cr *argoproj.ClusterArgoCD, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsMetricsService(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsServiceMonitor(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsSecret(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileNotificationsSourceNamespacesResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileSourceNamespaceNotificationsConfigurationCR(cr *argoproj.ClusterArgoCD, sourceNamespace string) error {
	if !isNotificationsEnabled(cr) {
		return nil
	}
...
func (r *ReconcileClusterArgoCD) getNotificationsCommand(cr *argoproj.ClusterArgoCD) []string {
...
func getNotificationsResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
...
func (r *ReconcileClusterArgoCD) setManagedNotificationsSourceNamespaces(cr *argoproj.ClusterArgoCD) error {
	if r.ManagedNotificationsSourceNamespaces == nil {
		r.ManagedNotificationsSourceNamespaces = make(map[string]string)
	}
...
func (r *ReconcileClusterArgoCD) removeUnmanagedNotificationsSourceNamespaceResources(cr *argoproj.ClusterArgoCD) error {
...
func isNotificationsEnabled(cr *argoproj.ClusterArgoCD) bool {
...
func (r *ReconcileClusterArgoCD) cleanupUnmanagedNotificationsSourceNamespaceResources(cr *argoproj.ClusterArgoCD, ns string) error {
	namespace := corev1.Namespace{}
...
func (r *ReconcileClusterArgoCD) getNotificationsSourceNamespaces(cr *argoproj.ClusterArgoCD) []string {
	if isNotificationsEnabled(cr) {
