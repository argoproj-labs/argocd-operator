...
func (r *ReconcileClusterArgoCD) clusterResourceMapper(ctx context.Context, o client.Object) []reconcile.Request {
...
func (r *ReconcileClusterArgoCD) isUserManagedSecret(ctx context.Context, o client.Object) (client.ObjectKey, bool) {
...
func (r *ReconcileClusterArgoCD) tlsSecretMapper(ctx context.Context, o client.Object) []reconcile.Request {
	var result = []reconcile.Request{}
...
// ArgoCD object that we want to reconcile.
func (r *ReconcileClusterArgoCD) namespaceResourceMapper(ctx context.Context, o client.Object) []reconcile.Request {
	var result = []reconcile.Request{}
...
// ArgoCD object that we want to reconcile.
func (r *ReconcileClusterArgoCD) clusterSecretResourceMapper(ctx context.Context, o client.Object) []reconcile.Request {
	var result = []reconcile.Request{}
...
func (r *ReconcileClusterArgoCD) applicationSetSCMTLSConfigMapMapper(ctx context.Context, o client.Object) []reconcile.Request {
	var result = []reconcile.Request{}
...
// ArgoCD object that we want to reconcile.
func (r *ReconcileClusterArgoCD) nmMapper(ctx context.Context, o client.Object) []reconcile.Request {
	var result []reconcile.Request
