...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDValidator) DeepCopyInto(out *ArgoCDValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDValidator.
func (in *ArgoCDValidator) DeepCopy() *ArgoCDValidator {
	if in == nil {
		return nil
	}
	out := new(ArgoCDValidator)
	in.DeepCopyInto(out)
	return out
}
