...
func (r *ReconcileClusterArgoCD) getArgoApplicationSetCommand(cr *argoproj.ClusterArgoCD) []string {
	cmd := make([]string, 0)
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetController(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetDeployment(cr *argoproj.ClusterArgoCD, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) applicationSetContainer(cr *argoproj.ClusterArgoCD, addSCMGitlabVolumeMount bool) corev1.Container {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetServiceAccount(cr *argoproj.ClusterArgoCD) (*corev1.ServiceAccount, error) {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetClusterRole(cr *argoproj.ClusterArgoCD) (*v1.ClusterRole, error) {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetClusterRoleBinding(cr *argoproj.ClusterArgoCD, role *v1.ClusterRole, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetSourceNamespacesResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetRole(cr *argoproj.ClusterArgoCD) (*v1.Role, error) {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetRoleBinding(cr *argoproj.ClusterArgoCD, role *v1.Role, sa *corev1.ServiceAccount) error {
...
func getApplicationSetContainerImage(cr *argoproj.ClusterArgoCD) string {
...
func getApplicationSetResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
...
func (r *ReconcileClusterArgoCD) reconcileApplicationSetService(cr *argoproj.ClusterArgoCD) error {
	log.Info("reconciling applicationset service")
...
func (r *ReconcileClusterArgoCD) removeUnmanagedApplicationSetSourceNamespaceResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) cleanupUnmanagedApplicationSetSourceNamespaceResources(cr *argoproj.ClusterArgoCD, ns string) error {
	namespace := corev1.Namespace{}
...
func (r *ReconcileClusterArgoCD) setManagedApplicationSetSourceNamespaces(cr *argoproj.ClusterArgoCD) error {
	if r.ManagedApplicationSetSourceNamespaces == nil {
		r.ManagedApplicationSetSourceNamespaces = make(map[string]string)
	}
...
func (r *ReconcileClusterArgoCD) reconcileSourceNamespaceRole(role v1.Role, cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileSourceNamespaceRoleBinding(roleBinding v1.RoleBinding, cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) getApplicationSetSourceNamespaces(cr *argoproj.ClusterArgoCD) []string {
	if cr.Spec.ApplicationSet != nil {
