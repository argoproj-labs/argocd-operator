...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDRedisHASpec) DeepCopyInto(out *ArgoCDRedisHASpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDRedisHASpec.
func (in *ArgoCDRedisHASpec) DeepCopy() *ArgoCDRedisHASpec {
	if in == nil {
		return nil
	}
	out := new(ArgoCDRedisHASpec)
	in.DeepCopyInto(out)
	return out
}
