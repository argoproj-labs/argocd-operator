...
func (r *ReconcileClusterArgoCD) reconcileStatus(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
...
func (r *ReconcileClusterArgoCD) reconcileStatusApplicationController(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileStatusApplicationSetController(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileStatusSSO(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
...
func (r *ReconcileClusterArgoCD) reconcileStatusPhase(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	var phase string
...
func (r *ReconcileClusterArgoCD) reconcileStatusRedis(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileStatusServer(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileStatusNotifications(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileStatusHost(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
	argocdStatus.Host = ""
