...
func Test_custom_startup_script_dex(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			require.Contains(t, outputYAML, "type: etcd", "expected kubernetes storage type not found")
			require.Contains(t, outputYAML, "namespace: dex", "expected postgres storage config in-cluster not found")
