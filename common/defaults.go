...
`
	...
	GitOpsPromoterDefaultImageName = "quay.io/argoprojlabs/gitops-promoter:v0.39.0"

	// GitopsPromoterExtensionInstallerName is the default url for the GitOps Promoter extension
	GitopsPromoterExtensionURL = "https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.39.0/gitops-promoter-argocd-extension.tar.gz"
)
