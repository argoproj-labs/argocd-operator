...
[**TrustCert**](#trust-certificate) | [Object] | Add a Trust Certificate.
...
Add control trust certificates to Dex.

Name | Default | Description
--- | --- | ---
TrustCert.Enabled | [false] | Toggle creation of an secret with certificate.
TrustCert.Cert    | [string] | Certificate data.
