...
func TestReconcileArgoCD_reconcileDexDeployment_with_dex_disabled(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := r.Get(context.TODO(), types.NamespacedName{Name: "argocd-dex-server", Namespace: test.argoCD.Spec.ControlPlaneNamespace}, deployment)
...
func TestReconcileArgoCD_reconcileDexService_removes_dex_when_disabled(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err := r.Get(context.TODO(), types.NamespacedName{Name: "argocd-dex-server", Namespace: test.argoCD.Spec.ControlPlaneNamespace}, service)
			assert.NoError(t, err)
...
func TestReconcileArgoCD_reconcileDexServiceAccount_removes_dex_when_disabled(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			err = r.Get(context.TODO(), types.NamespacedName{Name: sa.Name, Namespace: test.argoCD.Spec.ControlPlaneNamespace}, sa)
			assert.NoError(t, err)
...
func TestReconcileArgoCD_reconcileRole_dex_disabled(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			assert.NoError(t, createNamespace(r, test.argoCD.Spec.ControlPlaneNamespace, ""))
			...
			err = r.Get(context.TODO(), types.NamespacedName{Name: role.Name, Namespace: test.argoCD.Spec.ControlPlaneNamespace}, role)
			assert.NoError(t, err)
...
func TestReconcileArgoCD_reconcileRoleBinding_dex_disabled(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			assert.NoError(t, r.Get(context.TODO(), types.NamespacedName{Name: roleBinding.Name, Namespace: test.argoCD.Spec.ControlPlaneNamespace}, roleBinding))

			// ensure roleBinding was created correctly
			err := r.Get(context.TODO(), types.NamespacedName{Name: roleBinding.Name, Namespace: test.argoCD.Spec.ControlPlaneNamespace}, roleBinding)
			assert.NoError(t, err)
