...
func newClusterRoleBinding(cr *argoproj.ClusterArgoCD) *v1.ClusterRoleBinding {
...
func newClusterRoleBindingWithname(name string, cr *argoproj.ClusterArgoCD) *v1.ClusterRoleBinding {
...
func newRoleBinding(cr *argoproj.ClusterArgoCD) *v1.RoleBinding {
...
func newRoleBindingForSupportNamespaces(cr *argoproj.ClusterArgoCD, namespace string) *v1.RoleBinding {
	return &v1.RoleBinding{
		ObjectMeta: metav1.ObjectMeta{
...
func newRoleBindingWithname(name string, cr *argoproj.ClusterArgoCD) *v1.RoleBinding {
...
func (r *ReconcileClusterArgoCD) reconcileRoleBindings(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileRoleBinding(name string, rules []v1.PolicyRule, cr *argoproj.ClusterArgoCD) error {
...
func getRoleNameForApplicationSourceNamespaces(targetNamespace string, cr *argoproj.ClusterArgoCD) string {
...
func newRoleBindingWithNameForApplicationSourceNamespaces(namespace string, cr *argoproj.ClusterArgoCD) *v1.RoleBinding {
...
func (r *ReconcileClusterArgoCD) reconcileClusterRoleBinding(name string, role *v1.ClusterRole, cr *argoproj.ClusterArgoCD) error {
