...
import (
	...
	argoprojv1alpha1 "github.com/jmckind/argocd-operator/pkg/apis/argoproj/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &argoprojv1alpha1.ArgoCD{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *argoprojv1alpha1.ArgoCD) *corev1.Pod {
