...
// replicas value is < 0.
func getArgoCDRepoServerReplicas(cr *argocdoperatorv1beta1.ClusterArgoCD) *int32 {
...
func getArgoRepoCommand(cr *argocdoperatorv1beta1.ClusterArgoCD, useTLSForRedis bool) []string {
	cmd := make([]string, 0)
...
func getRepoServerAddress(cr *argocdoperatorv1beta1.ClusterArgoCD) string {
...
func (r *ReconcileClusterArgoCD) reconcileRepoDeployment(cr *argocdoperatorv1beta1.ClusterArgoCD, useTLSForRedis bool) error {
...
func getArgoRepoResources(cr *argocdoperatorv1beta1.ClusterArgoCD) corev1.ResourceRequirements {
...
func getRepoServerContainerImage(cr *argocdoperatorv1beta1.ClusterArgoCD) string {
...
func isRepoServerTLSVerificationRequested(cr *argocdoperatorv1beta1.ClusterArgoCD) bool {
...
func (r *ReconcileClusterArgoCD) reconcileStatusRepo(cr *argocdoperatorv1beta1.ClusterArgoCD, argocdStatus *argocdoperatorv1beta1.ArgoCDStatus) error {
	status := "Unknown"
...
func (r *ReconcileClusterArgoCD) reconcileRepoServerTLSSecret(cr *argocdoperatorv1beta1.ClusterArgoCD, argocdStatus *argocdoperatorv1beta1.ArgoCDStatus) error {
