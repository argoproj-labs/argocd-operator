...
func newHorizontalPodAutoscaler(cr *argoproj.ClusterArgoCD) *autoscaling.HorizontalPodAutoscaler {
...
func newHorizontalPodAutoscalerWithName(name string, cr *argoproj.ClusterArgoCD) *autoscaling.HorizontalPodAutoscaler {
...
func newHorizontalPodAutoscalerWithSuffix(suffix string, cr *argoproj.ClusterArgoCD) *autoscaling.HorizontalPodAutoscaler {
...
func (r *ReconcileClusterArgoCD) reconcileServerHPA(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileAutoscalers(cr *argoproj.ClusterArgoCD) error {
