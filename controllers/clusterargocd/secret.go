...
func newCASecret(cr *argoproj.ClusterArgoCD) (*corev1.Secret, error) {
...
func newCertificateSecret(suffix string, caCert *x509.Certificate, caKey *rsa.PrivateKey, cr *argoproj.ClusterArgoCD) (*corev1.Secret, error) {
...
func (r *ReconcileClusterArgoCD) reconcileArgoSecret(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileClusterSecrets(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileExistingArgoSecret(cr *argoproj.ClusterArgoCD, secret *corev1.Secret, clusterSecret *corev1.Secret, tlsSecret *corev1.Secret) error {
	changed := false
	explanation := ""
...
func (r *ReconcileClusterArgoCD) reconcileGrafanaSecret(cr *argoproj.ClusterArgoCD) error {
	//lint:ignore SA1019 known to be deprecated
	if !cr.Spec.Grafana.Enabled { //nolint:staticcheck // SA1019: We must test deprecated fields.
...
func generateSortedManagedNamespaceListForArgoCDCR(cr *argoproj.ClusterArgoCD, rClient client.Client) ([]string, error) {
...
func (r *ReconcileClusterArgoCD) reconcileClusterPermissionsSecret(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileRedisTLSSecret(cr *argoproj.ClusterArgoCD, useTLSForRedis bool, argocdStatus *argoproj.ArgoCDStatus) error {
...
func (r *ReconcileClusterArgoCD) reconcileSecrets(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) getClusterSecrets(cr *argoproj.ClusterArgoCD) (*corev1.SecretList, error) {
