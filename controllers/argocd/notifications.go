...
func (r *ArgoCDReconciler) deleteNotificationsResources(cr *argoprojv1a1.ArgoCD) error {
...
func (r *ArgoCDReconciler) reconcileNotificationsServiceAccount(cr *argoprojv1a1.ArgoCD) (*corev1.ServiceAccount, error) {
...
func (r *ArgoCDReconciler) reconcileNotificationsRole(cr *argoprojv1a1.ArgoCD) (*rbacv1.Role, error) {
...
func (r *ArgoCDReconciler) reconcileNotificationsRoleBinding(cr *argoprojv1a1.ArgoCD, role *rbacv1.Role, sa *corev1.ServiceAccount) error {
...
func (r *ArgoCDReconciler) reconcileNotificationsDeployment(cr *argoprojv1a1.ArgoCD, sa *corev1.ServiceAccount) error {
...
func (r *ArgoCDReconciler) reconcileNotificationsConfigMap(cr *argoprojv1a1.ArgoCD) error {
