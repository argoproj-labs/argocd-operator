...
func (r *ReconcileClusterArgoCD) createRBACConfigMap(cm *corev1.ConfigMap, cr *argoproj.ClusterArgoCD) error {
...
func getApplicationInstanceLabelKey(cr *argoproj.ClusterArgoCD) string {
...
func setRespectRBAC(cr *argoproj.ClusterArgoCD, data map[string]string) map[string]string {
...
func getCAConfigMapName(cr *argoproj.ClusterArgoCD) string {
...
func getSCMRootCAConfigMapName(cr *argoproj.ClusterArgoCD) string {
...
func getGATrackingID(cr *argoproj.ClusterArgoCD) string {
...
func getHelpChatURL(cr *argoproj.ClusterArgoCD) string {
...
func getHelpChatText(cr *argoproj.ClusterArgoCD) string {
...
func getKustomizeBuildOptions(cr *argoproj.ClusterArgoCD) string {
...
func getOIDCConfig(cr *argoproj.ClusterArgoCD) string {
...
func getRBACPolicy(cr *argoproj.ClusterArgoCD) string {
...
func getRBACDefaultPolicy(cr *argoproj.ClusterArgoCD) string {
...
func getRBACScopes(cr *argoproj.ClusterArgoCD) string {
...
func getResourceHealthChecks(cr *argoproj.ClusterArgoCD) map[string]string {
...
func getResourceIgnoreDifferences(cr *argoproj.ClusterArgoCD) (map[string]string, error) {
...
func getResourceActions(cr *argoproj.ClusterArgoCD) map[string]string {
...
func getResourceExclusions(cr *argoproj.ClusterArgoCD) (string, error) {
...
func getResourceInclusions(cr *argoproj.ClusterArgoCD) string {
...
func getResourceTrackingMethod(cr *argoproj.ClusterArgoCD) string {
...
func getInitialSSHKnownHosts(cr *argoproj.ClusterArgoCD) string {
...
func getInitialTLSCerts(cr *argoproj.ClusterArgoCD) map[string]string {
...
func newConfigMap(cr *argoproj.ClusterArgoCD) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
...
func newConfigMapWithName(name string, cr *argoproj.ClusterArgoCD) *corev1.ConfigMap {
	cm := newConfigMap(cr)
	cm.Name = name
...
func (r *ReconcileClusterArgoCD) reconcileConfigMaps(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) error {
...
func (r *ReconcileClusterArgoCD) reconcileArgoConfigMap(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileGrafanaConfiguration(cr *argoproj.ClusterArgoCD) error {
	//lint:ignore SA1019 known to be deprecated
...
func (r *ReconcileClusterArgoCD) reconcileGrafanaDashboards(cr *argoproj.ClusterArgoCD) error {
	//lint:ignore SA1019 known to be deprecated
	if !cr.Spec.Grafana.Enabled { //nolint:staticcheck // SA1019: We must test deprecated fields.
		return nil // Grafana not enabled, do nothing.
	}
...
func (r *ReconcileClusterArgoCD) reconcileRBACConfigMap(cm *corev1.ConfigMap, cr *argoproj.ClusterArgoCD) error {
	changed := false
	explanation := ""
	// Policy CSV
...
// not.
func modifyOwnerReferenceIfNeeded(cr *argoproj.ClusterArgoCD, cm *corev1.ConfigMap, scheme *runtime.Scheme) (bool, error) {
	changed := false
...
func (r *ReconcileClusterArgoCD) reconcileRedisConfiguration(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) error {
...
func (r *ReconcileClusterArgoCD) reconcileRedisHAHealthConfigMap(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) error {
...
func (r *ReconcileClusterArgoCD) reconcileRedisHAConfigMap(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) error {
...
func (r *ReconcileClusterArgoCD) reconcileArgoCmdParamsConfigMap(cr *argoproj.ClusterArgoCD) error {
