...
func TestReconcileClusterArgoCD_clusterRoleBindingMapper(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := r.clusterResourceMapper(context.TODO(), tt.args.o); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ReconcileClusterArgoCD.clusterRoleBindingMapper() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestReconcileClusterArgoCD_tlsSecretMapperRepoServer(t *testing.T) {
...
func TestReconcileClusterArgoCD_tlsSecretMapperRedis(t *testing.T) {
	argocd := &argoproj.ArgoCD{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "argocd",
			Namespace: "argocd-operator",
...
func TestReconcileClusterArgoCD_namespaceResourceMapperWithManagedByLabel(t *testing.T) {
	...
	a.Spec.ControlPlaneNamespace = "newTestNamespace"
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := r.namespaceResourceMapper(context.TODO(), tt.o); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ReconcileClusterArgoCD.namespaceResourceMapper(), got = %v, want = %v", got, tt.want)
			}
		})
	}
}

func TestReconcileClusterArgoCD_namespaceResourceMapperForSpecificNamespaceWithoutManagedByLabel(t *testing.T) {
	argocd1 := makeTestClusterArgoCD()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := r.namespaceResourceMapper(context.TODO(), tt.o); !assert.ElementsMatch(t, got, tt.want) {
				t.Errorf("ReconcileClusterArgoCD.sourceNamespaceMapper(), got = %v, want = %v", got, tt.want)
			}
		})
	}
}

func TestReconcileClusterArgoCD_namespaceResourceMapperForWildCardPatternNamespaceWithoutManagedByLabel(t *testing.T) {
	argocd1 := makeTestClusterArgoCD()
	resObjs := []client.Object{argocd1}
	subresObjs := []client.Object{argocd1}
	runtimeObjs := []runtime.Object{}
...
func TestReconcileClusterArgoCD_namespaceResourceMapperForMultipleSourceNamespacesWithoutManagedByLabel(t *testing.T) {
	argocd1 := makeTestClusterArgoCD()
	resObjs := []client.Object{argocd1}
	subresObjs := []client.Object{argocd1}
	runtimeObjs := []runtime.Object{}
...
func TestReconcileClusterArgoCD_namespaceResourceMapperForWildCardNamespaceWithoutManagedByLabel(t *testing.T) {
	argocd1 := makeTestClusterArgoCD()
	resObjs := []client.Object{argocd1}
	subresObjs := []client.Object{argocd1}
	runtimeObjs := []runtime.Object{}
...
func TestReconcileClusterArgoCD_tlsSecretMapperUserManagedSecret(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			argocd: makeClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
...
func TestReconcileClusterArgoCD_nmMapper(t *testing.T) {
	a := makeTestClusterArgoCD()
