...
func getPrometheusHost(cr *argoproj.ClusterArgoCD) string {
...
func getPrometheusReplicas(cr *argoproj.ClusterArgoCD) *int32 {
...
func hasPrometheusSpecChanged(actual *monitoringv1.Prometheus, desired *argoproj.ClusterArgoCD) bool {
	// Replica count
...
func newPrometheus(cr *argoproj.ClusterArgoCD) *monitoringv1.Prometheus {
...
func newServiceMonitor(cr *argoproj.ClusterArgoCD) *monitoringv1.ServiceMonitor {
...
func newServiceMonitorWithName(name string, cr *argoproj.ClusterArgoCD) *monitoringv1.ServiceMonitor {
...
func newServiceMonitorWithSuffix(suffix string, cr *argoproj.ClusterArgoCD) *monitoringv1.ServiceMonitor {
