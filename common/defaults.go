...
// DefaultIngressAnnotations will return the default Ingress Annotations.
func DefaultIngressAnnotations() map[string]string {
...
func LabelsForCluster(meta metav1.ObjectMeta) map[string]string {
...
// NameWithSuffix will return a name based on the given ObjectMeta. The given suffix is appended to the generated name.
// Example: Given an ObjectMeta with the name "example", providing the suffix "foo" would result in the value of
// "example-foo" being returned.
