...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDScope) DeepCopyInto(out *ArgoCDScope) {
	*out = *in
	if in.Cluster != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDScope.
func (in *ArgoCDScope) DeepCopy() *ArgoCDScope {
	if in == nil {
		return nil
	}
	out := new(ArgoCDScope)
...
func (in *ArgoCDSpec) DeepCopyInto(out *ArgoCDSpec) {
	*out = *in
	in.ManagementScope.DeepCopyInto(&out.ManagementScope)
