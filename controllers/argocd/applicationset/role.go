...
func (asr *ApplicationSetReconciler) reconcileRole() error {
	...
	if err != nil {
		...
		asr.Logger.Info("reconcileRole: role created", "name", desiredRole.Name, "namespace", desiredRole.Namespace)
		return nil
	}
	...
	asr.Logger.Info("reconcileRole: role updated", "name", existingRole.Name, "namespace", existingRole.Namespace)
	return nil
}
...
func (asr *ApplicationSetReconciler) deleteRole(name, namespace string) error {
	...
	asr.Logger.Info("DeleteRole: role deleted", "name", name, "namespace", namespace)
	return nil
}
