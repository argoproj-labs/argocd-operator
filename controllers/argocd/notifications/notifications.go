...
func (nr *NotificationsReconciler) Reconcile() error {
	...
	nr.Logger = ctrl.Log.WithName(common.ArgoCDNotificationsControllerComponent).WithValues("instance", nr.Instance.Name, "instance-namespace", nr.Instance.Namespace)

	resourceName = argoutil.GenerateUniqueResourceName(nr.Instance.Name, nr.Instance.Namespace, common.ArgoCDNotificationsControllerComponent)
	resourceLabels = common.DefaultResourceLabels(resourceName, nr.Instance.Name, common.ArgoCDNotificationsControllerComponent)
