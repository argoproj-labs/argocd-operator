...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDRC) DeepCopyInto(out *ArgoCDRC) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDRC.
func (in *ArgoCDRC) DeepCopy() *ArgoCDRC {
	if in == nil {
		return nil
	}
	out := new(ArgoCDRC)
...
func (in *ArgoCDSpec) DeepCopyInto(out *ArgoCDSpec) {
	*out = *in
	...
	if in.ResourceCustomizationsNew != nil {
		in, out := &in.ResourceCustomizationsNew, &out.ResourceCustomizationsNew
		*out = new(ResourceCustomizationsNew)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceCustomizationsNew) DeepCopyInto(out *ResourceCustomizationsNew) {
	*out = *in
	if in.Health != nil {
		in, out := &in.Health, &out.Health
		*out = make([]ArgoCDRC, len(*in))
		copy(*out, *in)
	}
	if in.Actions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceCustomizationsNew.
func (in *ResourceCustomizationsNew) DeepCopy() *ResourceCustomizationsNew {
	if in == nil {
		return nil
	}
	out := new(ResourceCustomizationsNew)
