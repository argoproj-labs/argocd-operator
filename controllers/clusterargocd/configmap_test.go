...
func TestReconcileClusterArgoCD_reconcileTLSCerts(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(initialCerts(t, "root-ca.example.com"))
	...
	assert.NoError(t, r.Get(
		...
		types.NamespacedName{
			...
			Namespace: a.Spec.ControlPlaneNamespace,
		},
		configMap))
...
func TestReconcileClusterArgoCD_reconcileTLSCerts_configMapUpdate(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(initialCerts(t, "root-ca.example.com"))
...
// TestReconcileClusterArgoCD_reconcileRedisHAHealthConfigMap tests the reconcileRedisHAHealthConfigMap function.
func TestReconcileClusterArgoCD_reconcileRedisHAHealthConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
// TestReconcileClusterArgoCD_reconcileRedisHAConfigMap tests the reconcileRedisHAConfigMap function.
func TestReconcileClusterArgoCD_reconcileRedisHAConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
func TestReconcileClusterArgoCD_reconcileTLSCerts_withInitialCertsUpdate(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	...
	a = makeTestClusterArgoCD(initialCerts(t, "testing.example.com"))
	assert.NoError(t, r.reconcileTLSCerts(a))
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	...
	cmdTests := []struct {
		...
		{
			"with-banner",
			[]argoCDOpt{func(a *argoproj.ClusterArgoCD) {
	...
	for _, tt := range cmdTests {
		a := makeTestClusterArgoCD(tt.opts...)
...
func TestReconcileClusterArgoCD_reconcileEmptyArgoConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withDisableAdmin(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withDexConnector(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	...
	tests := []struct {
		name             string
		updateCrSpecFunc func(cr *argoproj.ClusterArgoCD)
	}{
		{
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withDexDisabled(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_dexConfigDeletedwhenDexDisabled(t *testing.T) {
	logf.SetLogger(ZapLogger(true))

	tests := []struct {
		name              string
		updateCrFunc      func(cr *argoproj.ClusterArgoCD)
		argoCD            *argoproj.ClusterArgoCD
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withKustomizeVersions(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
...
func TestReconcileClusterArgoCD_reconcileGPGKeysConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
		a.Spec.DisableAdmin = true
	})
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withResourceTrackingMethod(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withResourceInclusions(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withNewResourceCustomizations(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withExtraConfig(t *testing.T) {
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withRespectRBAC(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withLocalUsers(t *testing.T) {
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withLocalUsers_extraConfigOverride(t *testing.T) {
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withInstallationID(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
...
func TestReconcileClusterArgoCD_reconcileArgoConfigMap_withMultipleInstances(t *testing.T) {
	logf.SetLogger(ZapLogger(true))

	// Create first ArgoCD instance
	argocd1 := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
		a.Name = "argocd-1"
		a.Spec.ControlPlaneNamespace = testNamespace
		a.Spec.InstallationID = "instance-1"
	})

	// Create second ArgoCD instance
	argocd2 := makeTestClusterArgoCD(func(a *argoproj.ClusterArgoCD) {
		a.Name = "argocd-2"
		a.Spec.ControlPlaneNamespace = testNamespace
...
func TestReconcileClusterArgoCD_RBACPolicyWithLogsPermissions(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
	a := makeTestClusterArgoCD()
...
func TestReconcileClusterArgoCD_RemovesLegacyLogEnforceFlag(t *testing.T) {
	// Setup fake ArgoCD instance and client
	cr := makeTestClusterArgoCD() // helper to create ArgoCD CR
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
			Name:      common.ArgoCDConfigMapName,
	...
	r := &ReconcileClusterArgoCD{Client: client, Scheme: scheme}
...
func TestReconcileClusterArgoCD_reconcileArgoCmdParamsConfigMap(t *testing.T) {
	logf.SetLogger(ZapLogger(true))
