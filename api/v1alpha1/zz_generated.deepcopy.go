...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDRolloutsStatus) DeepCopyInto(out *ArgoCDRolloutsStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDRolloutsStatus.
func (in *ArgoCDRolloutsStatus) DeepCopy() *ArgoCDRolloutsStatus {
	if in == nil {
		return nil
	}
	out := new(ArgoCDRolloutsStatus)
	in.DeepCopyInto(out)
	return out
}
