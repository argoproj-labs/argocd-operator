...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterController(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterControllerEnabled(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterControllerDisabled(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterServiceAccount(cr *argoproj.ClusterArgoCD) (*corev1.ServiceAccount, error) {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterRole(cr *argoproj.ClusterArgoCD) (*rbacv1.Role, error) {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterRoleBinding(cr *argoproj.ClusterArgoCD, role *rbacv1.Role, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterClusterRole(cr *argoproj.ClusterArgoCD) (*rbacv1.ClusterRole, error) {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterClusterRoleBinding(cr *argoproj.ClusterArgoCD, clusterRole *rbacv1.ClusterRole, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterSecret(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterConfigMap(cr *argoproj.ClusterArgoCD, desiredConfigMap *corev1.ConfigMap) error {
...
func (r *ReconcileClusterArgoCD) reconcileImageUpdaterDeployment(cr *argoproj.ClusterArgoCD, sa *corev1.ServiceAccount) error {
...
func (r *ReconcileClusterArgoCD) reconcileRoleBindingHelper(cr *argoproj.ClusterArgoCD, desiredRoleBinding client.Object) error {
...
func (r *ReconcileClusterArgoCD) reconcileSecretConfigMapHelper(cr *argoproj.ClusterArgoCD, desiredResource client.Object) error {
	resourceExists := true
...
func getImageUpdaterResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
