...
func ReconcileAgentRole(client client.Client, compName string, cr *argoproj.ClusterArgoCD, scheme *runtime.Scheme) (*v1.Role, error) {
...
func ReconcileAgentClusterRoles(client client.Client, compName string, cr *argoproj.ClusterArgoCD, scheme *runtime.Scheme) (*v1.ClusterRole, error) {
