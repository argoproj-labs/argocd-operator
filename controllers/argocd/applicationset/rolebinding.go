...
func (asr *ApplicationSetReconciler) reconcileRoleBinding() error {
	...
	if err != nil {
		...
		asr.Logger.Info("reconcileRoleBinding: roleBinding created", "name", desiredRoleBinding.Name, "namespace", desiredRoleBinding.Namespace)
		return nil
	}
	...
	asr.Logger.Info("reconcileRoleBinding: roleBinding updated", "name", existingRoleBinding.Name, "namespace", existingRoleBinding.Namespace)
...
func (asr *ApplicationSetReconciler) deleteRoleBinding(name, namespace string) error {
	...
	asr.Logger.Info("DeleteRoleBinding: roleBinding deleted", "name", name, "namespace", namespace)
	return nil
}
