...
func UseDex(cr *argoproj.ClusterArgoCD) bool {
	if cr.Spec.SSO != nil {
...
func (r *ReconcileClusterArgoCD) reconcileDexConfiguration(cm *corev1.ConfigMap, cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) getOpenShiftDexConfig(cr *argoproj.ClusterArgoCD) (string, error) {
	groups := []string{}
...
func addDexConfigFromCR(cr *argoproj.ClusterArgoCD, dex map[string]interface{}) error {
...
func (r *ReconcileClusterArgoCD) reconcileDexServiceAccount(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileDexDeployment(cr *argoproj.ClusterArgoCD) error {
	deploy := newDeploymentWithSuffix("dex-server", "dex-server", cr)
...
func (r *ReconcileClusterArgoCD) reconcileDexResources(cr *argoproj.ClusterArgoCD) error {
