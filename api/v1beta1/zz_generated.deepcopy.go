...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDRouteTLS) DeepCopyInto(out *ArgoCDRouteTLS) {
	*out = *in
	in.TLSConfig.DeepCopyInto(&out.TLSConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDRouteTLS.
func (in *ArgoCDRouteTLS) DeepCopy() *ArgoCDRouteTLS {
	if in == nil {
		return nil
	}
	out := new(ArgoCDRouteTLS)
