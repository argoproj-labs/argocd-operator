...
func getArgoApplicationControllerResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
...
func getArgoApplicationControllerCommand(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) []string {
...
func getArgoContainerImage(cr *argoproj.ClusterArgoCD) string {
...
func getArgoServerInsecure(cr *argoproj.ClusterArgoCD) bool {
	return cr.Spec.Server.Insecure
}

func isRedisTLSVerificationDisabled(cr *argoproj.ClusterArgoCD) bool {
	return cr.Spec.Redis.DisableTLSVerification
}

// getArgoServerGRPCHost will return the GRPC host for the given ArgoCD.
func getArgoServerGRPCHost(cr *argoproj.ClusterArgoCD) string {
...
func getArgoServerHost(cr *argoproj.ClusterArgoCD) string {
	host := cr.Name
...
func getArgoServerResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
	resources := corev1.ResourceRequirements{}
...
func (r *ReconcileClusterArgoCD) getArgoServerURI(cr *argoproj.ClusterArgoCD) (string, error) {
...
func getArgoServerOperationProcessors(cr *argoproj.ClusterArgoCD) int32 {
...
func getArgoServerStatusProcessors(cr *argoproj.ClusterArgoCD) int32 {
...
func getArgoControllerParellismLimit(cr *argoproj.ClusterArgoCD) int32 {
...
func getRedisContainerImage(cr *argoproj.ClusterArgoCD) string {
...
func getRedisHAContainerImage(cr *argoproj.ClusterArgoCD) string {
	defaultImg, defaultTag := false, false
	img := cr.Spec.Redis.Image
	if img == "" {
		img = common.ArgoCDDefaultRedisImage
...
func getRedisHAProxyAddress(cr *argoproj.ClusterArgoCD) string {
...
func getRedisHAProxyContainerImage(cr *argoproj.ClusterArgoCD) string {
	defaultImg, defaultTag := false, false
...
// If an error occurs, an empty string value will be returned.
func getRedisInitScript(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) string {
...
// If an error occurs, an empty string value will be returned.
func getRedisHAProxyConfig(cr *argoproj.ClusterArgoCD, useTLSForRedis bool) string {
...
// If an error occurs, an empty string value will be returned.
func getRedisHAProxyScript(cr *argoproj.ClusterArgoCD) string {
...
func getRedisResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
	resources := corev1.ResourceRequirements{}
...
func getRedisHAResources(cr *argoproj.ClusterArgoCD) corev1.ResourceRequirements {
	resources := corev1.ResourceRequirements{}
...
func getRedisServerAddress(cr *argoproj.ClusterArgoCD) string {
...
func nameWithSuffix(suffix string, cr *argoproj.ClusterArgoCD) string {
...
func (r *ReconcileClusterArgoCD) reconcileCertificateAuthority(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileResources(cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus) error {
...
func (r *ReconcileClusterArgoCD) deleteClusterResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) removeManagedByLabelFromNamespaces(namespace string) error {
...
func (r *ReconcileClusterArgoCD) removeDeletionFinalizer(argocd *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) addDeletionFinalizer(argocd *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) setResourceWatches(bldr *builder.Builder, clusterResourceMapper, tlsSecretMapper, namespaceResourceMapper, clusterSecretResourceMapper, applicationSetGitlabSCMTLSConfigMapMapper, nmMapper handler.MapFunc) *builder.Builder {
	...
	deleteNotificationsPred := predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			newCR, ok := e.ObjectNew.(*argoproj.ClusterArgoCD)
			if !ok {
				return false
			}
			oldCR, ok := e.ObjectOld.(*argoproj.ClusterArgoCD)
			if !ok {
				return false
			}
	...
	bldr.For(&argoproj.ClusterArgoCD{}, builder.WithPredicates(deleteNotificationsPred, r.argoCDNamespaceManagementFilterPredicate()))
	...
	err := applyReconcilerHook(&argoproj.ClusterArgoCD{}, bldrHook, "")
	if err != nil {
...
func (r *ReconcileClusterArgoCD) triggerRollout(obj interface{}, key string) error {
	switch res := obj.(type) {
...
func (r *ReconcileClusterArgoCD) namespaceFilterPredicate() predicate.Predicate {
...
func (r *ReconcileClusterArgoCD) getSourceNamespaces(cr *argoproj.ClusterArgoCD) ([]string, error) {
...
func (r *ReconcileClusterArgoCD) setManagedSourceNamespaces(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) removeUnmanagedSourceNamespaceResources(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) cleanupUnmanagedSourceNamespaceResources(cr *argoproj.ClusterArgoCD, ns string) error {
...
func (r *ReconcileClusterArgoCD) cleanupAllSourceNamespaces(cr *argoproj.ClusterArgoCD) {
...
func getApplicationSetHTTPServerHost(cr *argoproj.ClusterArgoCD) (string, error) {
	host := cr.Name
...
func UseApplicationController(name string, cr *argoproj.ClusterArgoCD) bool {
...
func UseRedis(name string, cr *argoproj.ClusterArgoCD) bool {
...
func UseServer(name string, cr *argoproj.ClusterArgoCD) bool {
...
func updateStatusAndConditionsOfArgoCD(ctx context.Context, condition metav1.Condition, cr *argoproj.ClusterArgoCD, argocdStatus *argoproj.ArgoCDStatus, k8sClient client.Client, log logr.Logger) error {
...
func (r *ReconcileClusterArgoCD) reconcileArgoCDAgent(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) namespaceManagementFilterPredicate() predicate.Predicate {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
...
func (r *ReconcileClusterArgoCD) argoCDNamespaceManagementFilterPredicate() predicate.Predicate {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			valNew, ok := e.ObjectNew.(*argoproj.ClusterArgoCD)
			if !ok {
				return false
			}
			valOld, ok := e.ObjectOld.(*argoproj.ClusterArgoCD)
			if !ok {
				return false
			}
...
func (r *ReconcileClusterArgoCD) handleArgoCDNamespaceManagementUpdate(valNew, valOld *argoproj.ClusterArgoCD, k8sClient kubernetes.Interface) bool {
...
func (r *ReconcileClusterArgoCD) handleNamespaceManagementUpdate(oldNSMgmt, newNSMgmt *argoproj.NamespaceManagement, k8sClient kubernetes.Interface) bool {
	ns := &corev1.Namespace{}
...
func (r *ReconcileClusterArgoCD) handleNamespaceManagementDelete(nsMgmt *argoproj.NamespaceManagement, k8sClient kubernetes.Interface) bool {
	ns := &corev1.Namespace{}
...
func (r *ReconcileClusterArgoCD) reconcileDeploymentHelper(cr *argoproj.ClusterArgoCD, desiredDeployment *appsv1.Deployment, componentName string, enabled bool) error {
