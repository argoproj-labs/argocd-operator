...
func newServiceAccount(cr *argoproj.ClusterArgoCD) *corev1.ServiceAccount {
...
func newServiceAccountWithName(name string, cr *argoproj.ClusterArgoCD) *corev1.ServiceAccount {
...
func (r *ReconcileClusterArgoCD) reconcileServiceAccounts(cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileServiceAccountClusterPermissions(name string, rules []v1.PolicyRule, cr *argoproj.ClusterArgoCD) error {
...
func (r *ReconcileClusterArgoCD) reconcileServiceAccountPermissions(name string, rules []v1.PolicyRule, cr *argoproj.ClusterArgoCD) error {
	return r.reconcileRoleBinding(name, rules, cr)
}

func (r *ReconcileClusterArgoCD) reconcileServiceAccount(name string, cr *argoproj.ClusterArgoCD) (*corev1.ServiceAccount, error) {
