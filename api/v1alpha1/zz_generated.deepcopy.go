...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDTrustCerts) DeepCopyInto(out *ArgoCDTrustCerts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDTrustCerts.
func (in *ArgoCDTrustCerts) DeepCopy() *ArgoCDTrustCerts {
	if in == nil {
		return nil
	}
	out := new(ArgoCDTrustCerts)
	in.DeepCopyInto(out)
	return out
}
